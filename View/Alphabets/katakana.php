...
<?php $this->description = "Les katakanas sont les éléments d'un des trois ensembles de caractères de l'écriture japonaise avec les kanjis et les hiraganas";?>
    ...
    <article class="col-12 col-sm-10 text-center py-3">
        ...
        <blockquote class="blockquote text-justify m-0">
            <p>
                ...
                <br/> Les katakanas (片仮名, litt. « kanas fragmentaires ») sont un des deux syllabaires utilisés en japonais. Comme les hiraganas – l'autre syllabaire – les katakanas sont des signes correspondant à des syllabes (ka, ki, ku, ke, ko, etc.). Ils sont utilisés dans le système d'écriture japonais pour transcrire les mots étrangers, les noms propres étrangers, les noms scientifiques des plantes et animaux, et les onomatopées japonaises. Ils peuvent également servir à mettre en valeur dans un texte des mots qui s'écrivent normalement en kanjis ou en hiraganas, ou à écrire un prénom japonais si l'on ne connaît pas le(s) kanji(s) qui le compose(nt).
            </p>
            <footer class="blockquote-footer text-right">Wikipedia <cite><a href="https://fr.wikipedia.org/wiki/Katakana" target="_blank">voir plus</a></cite></footer>
        </blockquote>
    </article>
</section>

<?php require_once('Shared/alphabet_table.php');?>
