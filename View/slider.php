<div id="demo" class="row d-none d-md-block carousel slide" data-ride="carousel">
	...
	<a class="carousel-control-prev" href="#demo" data-slide="prev" title="Image précédente">
	    <span class="carousel-control-prev-icon"></span>
	</a>
	<a class="carousel-control-next" href="#demo" data-slide="next" title="Image suivante">
